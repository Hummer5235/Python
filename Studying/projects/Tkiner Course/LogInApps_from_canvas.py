...
window.geometry(f'{W}x{H}+{sc_width//2-W//2}+{sc_height//2-H//2}')
...
# lbl = Label(canvas,image=bg_image)
...
log_ent.place(relx=0.23,rely=0.3)

pass_ent = Entry(width=30,fg='grey')
pass_ent.insert(0,'Password')
pass_ent.place(relx=0.23,rely=0.4)
...
ok_btn = Button(text='Odnoklassniki',image=ok_image,compound=LEFT,font='Consolas 15',command=callback_ok,width=200,
                height=30,bg='white')
...
login_btn = Button(text='LogIn',font='Consolas 15 bold', bg='#ccc8fa',borderwidth=5,width=20,)
login_btn.place(relx=0.28,rely=0.5)

canvas.create_text(270,100,text='Log In',font='Consolas 25')
