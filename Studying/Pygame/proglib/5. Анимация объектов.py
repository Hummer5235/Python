...
font_info = pygame.font.SysFont("Verdana", 30, bold=True)
...
while True:
    ...
    if freeze:
        ...
        info_text = font_info.render("Нажмите Enter", True, white)
        screen.blit(info_text, (screen_width // 2-120, screen_height // 2))
