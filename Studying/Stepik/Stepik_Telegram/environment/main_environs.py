...
# То есть библиотека environs загружает переменные из файла .env в окружение,
# а затем может их оттуда читать. На всякий случай мы также убедились с помощью библиотеки os,
# что переменные, действительно, есть в окружении.