...
from aiogram.fsm.context import FSMContext  # Хранения контекста, в котором находятся пользователи при работе с машиной состояний.
from aiogram.fsm.state import default_state, State, StatesGroup
from aiogram.fsm.storage.memory import MemoryStorage # Все данные состояний всех пользователей во время работы FSM
...
# Этот хэндлер будет срабатывать на команду /start в состоянии по умолчанию
...
async def process_name_sent(message: Message, state: FSMContext):
    ...
    # Получить данные пользователя внутри машины состояний, текущее состояние
    print('data:', state.get_data())
