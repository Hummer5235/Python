...
positive_answers = ['да', 'давай', 'сыграем', 'игра','играть', 'хочу играть','ладно','хорошо','ок','давайте']
...
async def process_numbers_answer(message:Message):
    ...
    if users[user_id]['in_game']:
        if users[user_id]['secret_number'] == number_answer:
            users[user_id]['in_game']= False
            users[user_id]['total_games'] += 1
        ...
        elif number_answer < users[user_id]['secret_number'] :
