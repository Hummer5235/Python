# Урок 4
#4.1: Изображения объектов, выбор случайного изображения
import pygame
import random
...
def run_game():
    ...
    land = pygame.image.load("Pygame materials/Backgrounds/Land.jpg") # Фон
...
def create_cactus_arr(array):
    ...
    array.append(Cactus(display_width + 50 , height , width , img , 4))
